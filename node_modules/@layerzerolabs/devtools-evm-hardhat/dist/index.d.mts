import { S as SimulationConfig, a as SimulationUserConfig } from './type-extensions.mjs';
export { b as SimulationAnvilConfig, c as SimulationAnvilUserConfig } from './type-extensions.mjs';
import * as hardhat_types from 'hardhat/types';
import { Artifact, CLIArgumentType, HardhatUserConfig, HardhatRuntimeEnvironment, EthereumProvider, ConfigurableTaskDefinition, HardhatConfig, NetworkConfig } from 'hardhat/types';
...
import { Environment, Stage, EndpointId } from '@layerzerolabs/lz-definitions';
 ...
 * @returns `<THardhatUserConfig extends HardhatUserConfig>(config: THardhatUserConfig): THardhatUserConfig` Hardhat config decorator
 */
declare const withLayerZeroArtifacts: (...packageNames: string[]) => <THardhatUserConfig extends HardhatUserConfig>(config: THardhatUserConfig) => THardhatUserConfig;
 ...
 */
declare const createOmniNodeHardhatSchema: <TConfig = unknown>(configSchema: z.ZodType<TConfig, z.ZodTypeDef, unknown>) => z.ZodType<OmniNodeHardhat<TConfig>, z.ZodTypeDef, unknown>;
/**
 ...
 */
declare const createOmniEdgeHardhatSchema: <TConfig = unknown>(configSchema: z.ZodType<TConfig, z.ZodTypeDef, unknown>) => z.ZodType<OmniEdgeHardhat<TConfig>, z.ZodTypeDef, unknown>;
/**
 ...
 */
declare const createOmniGraphHardhatSchema: <TNodeConfig = unknown, TEdgeConfig = unknown>(nodeSchema: z.ZodType<OmniNodeHardhat<TNodeConfig>, z.ZodTypeDef, unknown>, edgeSchema: z.ZodType<OmniEdgeHardhat<TEdgeConfig>, z.ZodTypeDef, unknown>) => z.ZodType<OmniGraphHardhat<TNodeConfig, TEdgeConfig>, z.ZodTypeDef, unknown>;
