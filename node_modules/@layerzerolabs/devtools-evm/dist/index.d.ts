import { OmniAddress, WithEid, OmniPoint, Factory, IOmniSDK as IOmniSDK$1, EndpointBasedFactory, OmniTransaction, OmniSigner, OmniTransactionResponse } from '@layerzerolabs/devtools';
...
import Safe, { ConnectSafeConfig } from '@safe-global/protocol-kit';
...
declare abstract class OmniSignerEVMBase implements OmniSigner {
...
declare class GnosisOmniSignerEVM<TSafeConfig extends ConnectSafeConfig> extends OmniSignerEVMBase {
    ...
    constructor(eid: EndpointId, signer: Signer, safeUrl: string, safeConfig: TSafeConfig);
    sign(_transaction: OmniTransaction): Promise<string>;
