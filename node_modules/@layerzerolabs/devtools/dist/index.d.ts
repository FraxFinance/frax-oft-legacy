...
type PossiblyBytes = Bytes | Bytes32 | Bytes20;
/**
 ...
 * @returns {string}
 */
declare const makeBytes32: (address?: PossiblyBytes | null | undefined) => PossiblyBytes;
/**
 ...
 */
declare const ignoreZero: <T extends PossiblyBigInt>(value?: T | null | undefined) => T | undefined;
/**
 ...
 */
declare const tapError: <T>(task: Task<T>, onError: Factory<[
    error: unknown
], void>) => Promise<Awaited<T>>;
/**
 ...
 */
declare const createConfigureNodes: <TOmniGraph extends OmniGraph<unknown, unknown> = OmniGraph<unknown, unknown>, TOmniSDK = IOmniSDK>(createTransactions: CreateTransactionsFromOmniNodes<TOmniGraph, TOmniSDK>) => Configurator<TOmniGraph, TOmniSDK>;
/**
 ...
 * @returns {Configurator<TOmniGraph, TOmniSDK>}
 */
declare const createConfigureEdges: <TOmniGraph extends OmniGraph<unknown, unknown> = OmniGraph<unknown, unknown>, TOmniSDK = IOmniSDK>(createTransactions: CreateTransactionsFromOmniEdges<TOmniGraph, TOmniSDK>) => Configurator<TOmniGraph, TOmniSDK>;
/**
 ...
 * @returns {Configurator<TOmniGraph, TOmniSDK>}
 */
declare const createConfigureMultiple: <TOmniGraph extends OmniGraph<unknown, unknown> = OmniGraph<unknown, unknown>, TOmniSDK = IOmniSDK>(...configurators: Configurator<TOmniGraph, TOmniSDK>[]) => Configurator<TOmniGraph, TOmniSDK>;
...
declare const formatOmniPoint: ({ eid, address }: OmniPoint) => string;
...
declare const UIntNumberSchema: z.ZodNumber;
 ...
 */
declare const createOmniNodeSchema: <TConfig = unknown>(configSchema: z.ZodType<TConfig, z.ZodTypeDef, unknown>) => z.ZodType<OmniNode<TConfig>, z.ZodTypeDef, unknown>;
/**
 ...
 */
declare const createOmniEdgeSchema: <TConfig = unknown>(configSchema: z.ZodType<TConfig, z.ZodTypeDef, unknown>) => z.ZodType<OmniEdge<TConfig>, z.ZodTypeDef, unknown>;
/**
 ...
 */
declare const createOmniGraphSchema: <TNodeConfig = unknown, TEdgeConfig = unknown>(nodeSchema: z.ZodType<OmniNode<TNodeConfig>, z.ZodTypeDef, unknown>, edgeSchema: z.ZodType<OmniEdge<TEdgeConfig>, z.ZodTypeDef, unknown>) => z.ZodType<OmniGraph<TNodeConfig, TEdgeConfig>, z.ZodTypeDef, unknown>;
