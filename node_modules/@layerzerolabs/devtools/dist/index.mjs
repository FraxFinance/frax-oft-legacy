...
import { createModuleLogger, printJson, pluralizeNoun, pluralizeOrdinal } from '@layerzerolabs/io-devtools';
...
var makeBytes32 = (address) => hexZeroPad(address || "0x0", 32);
...
var UIntNumberSchema = z.coerce.number().nonnegative().int();
