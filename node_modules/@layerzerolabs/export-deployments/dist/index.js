...
var createConst = (modifiers = []) => (name) => (expression) => typescript.factory.createVariableStatement(
  modifiers,
  typescript.factory.createVariableDeclarationList(
    [typescript.factory.createVariableDeclaration(name, void 0, void 0, expression)],
    typescript.NodeFlags.Const
  )
);
var creteAsConst = (expression) => typescript.factory.createAsExpression(
  expression,
  typescript.factory.createTypeReferenceNode(typescript.factory.createIdentifier("const"), void 0)
);
