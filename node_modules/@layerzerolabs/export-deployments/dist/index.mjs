...
var createConst = (modifiers = []) => (name) => (expression) => factory.createVariableStatement(
  modifiers,
  factory.createVariableDeclarationList(
    [factory.createVariableDeclaration(name, void 0, void 0, expression)],
    NodeFlags.Const
  )
);
var creteAsConst = (expression) => factory.createAsExpression(
  expression,
