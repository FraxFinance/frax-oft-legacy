...
declare const createConfigLoader: <TConfig>(schema: z.ZodType<TConfig, z.ZodTypeDef, unknown>, logger?: winston.Logger) => (path: string) => Promise<TConfig>;
...
export { createConfigLoader, pluralizeNoun, pluralizeOrdinal };
